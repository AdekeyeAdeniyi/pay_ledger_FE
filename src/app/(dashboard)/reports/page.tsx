...
export default function ReportsPage() {
  ...
  return (
    ...
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center">
      <div className="w-20 h-20 bg-pl-primary-light text-pl-primary rounded-pl-full flex items-center justify-center mb-6">
        <BarChart3 size={40} />
      </div>

      <h1 className="text-3xl font-black text-pl-ink mb-3 tracking-tight">Advanced Reporting</h1>
      <p className="text-pl-ink-2 max-w-md mb-8 text-sm sm:text-base">
        We are putting the finishing touches on our new analytical engine. You will soon be able to visualize collection trends, export detailed audits, and monitor settlement performance in
        real-time.
      </p>

      <div className="flex gap-4">
        <Button variant="ghost" onClick={() => router.push("/dashboard")} icon={<ArrowLeft size={14} />}>
          Go Back
        </Button>
      </div>
    </div>
